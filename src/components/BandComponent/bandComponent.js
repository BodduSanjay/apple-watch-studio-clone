...
const BandComponent = () => {
  const { selectedCase, selectedBand } = useSelection();
    ...
    <div className="watch-preview">
      ...
      <main className="content">
        <CaseSlider
          ...
          isCaseSelection={false}
          backgroundImage={
            selectedCase ? selectedCase.image : "default-case.jpg"
          }
        />
